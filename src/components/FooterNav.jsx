    ...
    <div className="p-3">
      <footer className="bg-[#15151C] rounded-xl p-8">
        <div className="text-center">
          ...
          <p className="text-[10px] lg:w-[25%] my-2 mx-auto">Let us unleash our creativity and
        ...
        <div className="border-t pt-5 border-[#1D2739] lg:flex justify-between mt-5">
          <p className="text-xs sm:text-center">#fil africa</p>
          <p className="text-[9px] sm:text-center sm:my-4">© 2024 FIL Africa. All rights reserved.</p>
